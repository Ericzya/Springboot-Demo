describe 'Morris.Line', ->
  ...
  describe 'generating column labels', ->
    ...
    it 'should use com.cctv.springbootdemo.model.user-supplied x value strings by default', ->
      chart = Morris.Line
        element: 'graph'
    ...
    it 'should use com.cctv.springbootdemo.model.user-defined formatters', ->
      d = new Date(2012, 0, 1)
      chart = Morris.Line
        element: 'graph'
