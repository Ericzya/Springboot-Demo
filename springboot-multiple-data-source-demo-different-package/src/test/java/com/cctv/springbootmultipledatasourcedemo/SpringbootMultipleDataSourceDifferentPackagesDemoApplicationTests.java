...
@SpringBootTest(classes = SpringbootMultipleDataSourceDifferentPackagesDemoApplication.class)
@RunWith(SpringRunner.class)
class SpringbootMultipleDataSourceDifferentPackagesDemoApplicationTests {
