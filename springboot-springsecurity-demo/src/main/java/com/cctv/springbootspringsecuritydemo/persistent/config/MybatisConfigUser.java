package com.cctv.springbootspringsecuritydemo.persistent.config;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.cctv.springbootspringsecuritydemo.persistent.user", sqlSessionTemplateRef = "userSqlSessionTemplate")
