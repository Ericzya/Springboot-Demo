describe 'Morris.Grid#setData', ->
  ...
  it 'should not alter com.cctv.springbootdemo.model.user-supplied data', ->
  ...
  describe 'ymin/ymax', ->
    ...
    it 'should use a com.cctv.springbootdemo.model.user-specified minimum and maximum value', ->
    ...
    describe 'auto [n]', ->
      ...
      it 'should use a com.cctv.springbootdemo.model.user-specified minimum and maximum value given no data', ->
        line = Morris.Line $.extend @defaults,
          data: [{x: 1}, {x: 2}, {x: 3}, {x: 4}]
          ymin: 'auto 5'
          ymax: 'auto 20'
  ...
  describe 'timestamp data', ->
    ...
    it 'should use a com.cctv.springbootdemo.model.user-supplied formatter for labels', ->
      line = Morris.Line
        element: 'graph'
        data: [
